...
export const STRINGS = Object.freeze({
  en: {
    ...
    'button.notes': 'Notes',
    'button.finish': 'Finish the meeting',
    'button.clearNotes': 'New meeting',
    'button.downloadNotes': 'Download',

    'notes.title': 'Notes',
    'notes.note': 'Every line keeps the words it came from. Finishing asks for a closing summary; the conversation stays open afterwards.',
    'notes.empty': 'Nothing yet. Notes appear as the conversation goes.',
    'notes.off': 'Not following the conversation. Start with --observe to have Claude keep notes.',
    'notes.pending': '{count} line(s) waiting for the next batch',
    'notes.section.points': 'Points',
    'notes.section.decisions': 'Decisions',
    'notes.section.tasks': 'Tasks',
    'notes.section.questions': 'Open questions',
    'notes.section.flags': 'Flagged',
    'notes.finished': 'Meeting finished. Saved to {path}',
    'notes.cleared': 'Notes cleared. The conversation is still open.',
    'notes.working': 'Asking for a summary...',
  ...
  ru: {
    ...
    'button.notes': 'Конспект',
    'button.finish': 'Завершить встречу',
    'button.clearNotes': 'Новая встреча',
    'button.downloadNotes': 'Скачать',

    'notes.title': 'Конспект',
    'notes.note': 'За каждой строкой сохранены слова, из которых она взялась. Завершение запрашивает итоги; разговор после этого остаётся открытым.',
    'notes.empty': 'Пока пусто. Конспект наполняется по ходу разговора.',
    'notes.off': 'Разговор не отслеживается. Запустите с --observe, чтобы Клавдий вёл конспект.',
    'notes.pending': 'Строк ждёт следующей пачки: {count}',
    'notes.section.points': 'Тезисы',
    'notes.section.decisions': 'Решения',
    'notes.section.tasks': 'Задачи',
    'notes.section.questions': 'Открытые вопросы',
    'notes.section.flags': 'Замечено',
    'notes.finished': 'Встреча завершена. Сохранено в {path}',
    'notes.cleared': 'Конспект очищен. Разговор остаётся открытым.',
    'notes.working': 'Прошу итоги...',
